    ...
    <div className="flex h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100">
      ...
      <aside className={`fixed lg:relative w-64 lg:w-72 h-full bg-white dark:bg-neutral-800 border-r border-neutral-200 dark:border-neutral-700 flex flex-col transition-transform duration-300 z-30 shadow-md ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
        ...
        <div className="flex-shrink-0 p-4 border-b border-neutral-200 dark:border-neutral-600">
          ...
          {/* New Chat Button */}
          <button 
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-600 dark:hover:bg-neutral-500 text-neutral-800 dark:text-neutral-100 rounded-lg transition-colors duration-200 border border-neutral-300 dark:border-neutral-500 group"
                ...
                <li key={conv.id} className="relative group">
                  <div
                    className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all duration-200 ${
                      conv.id === activeId 
                        ? 'bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/50 shadow-sm' 
          ...
          />
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <button
                  onClick={handleNewChat}
                  className="inline-flex items-center px-6 py-3 bg-neutral-600 hover:bg-neutral-700 dark:bg-neutral-500 dark:hover:bg-neutral-400 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md"
                >
